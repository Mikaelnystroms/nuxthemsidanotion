globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/std-env/dist/index.mjs';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/h3/dist/index.mjs';
import { NotionAPI } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/notion-client/build/index.js';
import { createRenderer } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/vue/server-renderer/index.mjs';
import { withoutBase, parseURL, withQuery, joinURL } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/unstorage/dist/drivers/fs.mjs';
import defu from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ppIdA7bg9S = (function(nitro) {
...
const _dafqpZ = defineEventHandler((event) => {
  event.res.setHeader("Cache-Control", "s-maxage=120, stale-while-revalidate");
});

const _lazy_29Ffuh = () => Promise.resolve().then(function () { return _pageId_$1; });
const _lazy_x055C9 = () => Promise.resolve().then(function () { return notion; });
const _lazy_phvptD = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _dafqpZ, lazy: false, middleware: true, method: undefined },
  { route: '/api/page/:pageId', handler: _lazy_29Ffuh, lazy: true, middleware: false, method: undefined },
  { route: '/api/notion', handler: _lazy_x055C9, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_phvptD, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_phvptD, lazy: true, middleware: false, method: undefined }
];
...
const _pageId_$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _pageId_
});

const notion = /*#__PURE__*/Object.freeze({
  __proto__: null
});
...
const getClientManifest = () => import('/Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/mikaenys/opt/miniconda3/envs/nuxthemsidanotion/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>Mikael Nyström</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<link rel=\"icon\" type=\"image/x-icon\" href=\"/vl2.svg\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
